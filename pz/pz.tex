...
\begin{titlepage}
	...
	\begin{flushright}
		Выполнил: Стародубцев Тимофей\\
		студент гр. БПИ173\\
		Подпись: \underline{\phantom{DD.MM.YYYY}}\\[2em]
		Преподаватель: Максименкова О.В.,\\
		старший преподаватель\\
		департамента\\
		программной инженерии\\
		факультета компьютерных наук\\[2em]
		Дата представления: \underline{\phantom{DD.MM.YYYY}}\\[5em]
	\end{flushright}
